...
{'active': False,
 ...
 'Requiere:\n\n\tBeautifulSoup\n\n\tgeopy\n\n\n\n'
 'Para que el asistente funcione debe tener instalada ambos m\xc3\xb3dulos'
 ...
 '\n\n\n\nAttention, to run the wizard you need to have installed two'
 ' libraries in python.\n\nWithout these two libraries the wizard will'
 ' fail and will not update the information.\n\n\n\nInstall them using:'
 '\n\n\n\n\t$ pip install BeautifulSoup\n\n\t$ pip install geopy'
 '\n\n\n\nfrom the CLI.\n\n\n\n',
